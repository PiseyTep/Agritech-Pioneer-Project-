...
class NotificationService {
  ...
  // Private constructor - updated to remove secureStorage parameter
  ...
  Future<void> _registerFCMToken() async {
    ...
    if (token != null) {
      debugPrint(
          '🔑 FCM Token: ${token.substring(0, min(token.length, 10))}...');
    ...
    _messaging.onTokenRefresh.listen((newToken) async {
      debugPrint(
          '🔄 FCM Token refreshed: ${newToken.substring(0, min(newToken.length, 10))}...');
